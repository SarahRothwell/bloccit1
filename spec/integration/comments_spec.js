...
// #3
     ...
     //test to ensure a member cannot delete comments made by other members
     describe("POST /topics/:topicId/posts/:postId/comments/:id/destroy", () => {
       beforeEach((done) => {
          User.create({
        ...
        it("should not delete a comment made by another member", (done) => {
          Comment.all()
          .then((comments) => {
            const commentCountBeforeDelete = comments.length;
...
//CONTEXT FOR admin
  ...
  describe("signed in user performing CRUD actions for Comment", () => {
       ...
       describe("POST /topics/:topicId/posts/:postId/comments/:id/destroy", () => {
         ...
         it("admin should delete any comment from any member", (done) => {
           Comment.all()
           .then((comments) => {
             const commentCountBeforeDelete = comments.length;
