...
describe("guest user performing CRUD actions for Post", () => {
  ...
  beforeEach((done) => {
      request.get({         // mock authentication
        ...
        form: {
          userId: 0     // mock authenticate as guest user with no account
        }
      },
        (err, res, body) => {
          done();
    ...
    describe("GET /topics/:topicId/posts/:id", () => {
      ...
      it("should not render a view with the selected post", (done) => {
